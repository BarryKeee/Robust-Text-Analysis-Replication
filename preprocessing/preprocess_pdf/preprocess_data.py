...
with codecs.open(path.join(cwd, 'preprocessing', 'preprocess_pdf', 'stopwords_long.txt'), 'r', 'utf-8') as f:
    stp_long = set(f.read().splitlines())
with codecs.open(path.join(cwd, 'preprocessing', 'preprocess_pdf', 'stopwords_short.txt'), 'r', 'utf-8') as f:
